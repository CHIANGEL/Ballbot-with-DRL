...
class BallbotContinuousBulletEnv(gym.Env):
    ...
    def step(self, action):
        ...
        done=self.step_number > 1000 or reFloats[0] > 30 / 180 * math.pi or reFloats[0] < -30 / 180 * math.pi \
        ...
        return np.array(self.state), reward, done, {}, (theta_z / math.pi * 180.0)
    ...
    def reset(self, port):
        ...
        self.clientID = sim.simxStart('127.0.0.1', port, True, True, 10000, 1)  # Connect to CoppeliaSim
        if self.clientID != -1:
